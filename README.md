...
This tool takes ArgoCD Application custom resources and renders them into the
underlying Kubernetes manifests. It supports applications that use Helm charts
